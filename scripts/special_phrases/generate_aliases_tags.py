...
#for language in [ "es","ja","sl" ]:
    ...
    with open(fname_t2a, "w") as f:
        f.write('# ' + language.upper() + ': Tag and its main corresponding alias for \n\n')
        f.write('Tag | Alias \n')
        f.write('--- | --- \n')
    ...
    with open(fname_a2t, "w") as f:
        f.write('# ' + language.upper() + ': Aliases and the tags that they correspond to\n\n')
        f.write('Alias | Tag(s) \n')
        f.write('--- | --- \n')
